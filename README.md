...
<div align="center">
  <img src="https://skillicons.dev/icons?i=html,css,bootstrap,js,php,nodejs,nextjs,ts,bun,devto,figma,mysql,tailwind,discord,bots,discordjs,linux,arch,nix,mongodb,redis,sqlite,express,github,git,gitlab,notion,npm,replit,vscode,bash,docker,dotnet,robloxstudio,unity,sublime,vercel,cloudflare,workers,nginx,photoshop,ae,blender," alt="skills logo"  />
</div>
